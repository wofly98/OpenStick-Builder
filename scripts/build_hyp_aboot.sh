...
echo 'DEFINES += USE_TARGET_HS200_CAPS=1 WITH_LK2ND_DEVICE_2ND=1' >> src/lk2nd/project/lk1st-msm8916.mk

make -C src/lk2nd LK2ND_BUNDLE_DTB="msm8916-512mb-mtp.dtb" LK2ND_COMPATIBLE="yiming,uz801-v3" WITH_LK2ND_DEVICE_2ND=1 \
